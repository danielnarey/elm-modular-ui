...
var _danielnarey$elm_modular_ui$Page_Interactive$url = function (id) {
	var _p0 = id;
	switch (_p0.ctor) {
		case 'Index':
			return '/';
...
var _danielnarey$elm_modular_ui$Page_Interactive$fromPath = function (parsed) {
	var _p1 = _elm_lang$core$List$head(parsed);
	if (_p1.ctor === 'Nothing') {
...
var _danielnarey$elm_modular_ui$Page_Content$url = function (id) {
	var _p0 = id;
	switch (_p0.ctor) {
		case 'Index':
			return '/';
...
var _danielnarey$elm_modular_ui$Page_Content$fromPath = function (parsed) {
	var _p1 = _elm_lang$core$List$head(parsed);
	if (_p1.ctor === 'Nothing') {
...
var _danielnarey$elm_modular_ui$Page_Customize$url = function (id) {
	var _p0 = id;
	switch (_p0.ctor) {
		case 'Index':
			return '/';
...
var _danielnarey$elm_modular_ui$Page_Customize$fromPath = function (parsed) {
	var _p1 = _elm_lang$core$List$head(parsed);
	if (_p1.ctor === 'Nothing') {
...
var _danielnarey$elm_modular_ui$Page$url = function (id) {
	var path = function () {
		var _p0 = id;
		switch (_p0.ctor) {
			case 'Home':
			...
			case 'Interactive':
				return A2(
					...
					_danielnarey$elm_modular_ui$Page_Interactive$url(_p0._0));
			case 'Content':
				return A2(
					_elm_lang$core$String$append,
					'/content-elements',
					_danielnarey$elm_modular_ui$Page_Content$url(_p0._0));
			default:
				return A2(
					_elm_lang$core$String$append,
					'/customize',
					_danielnarey$elm_modular_ui$Page_Customize$url(_p0._0));
		}
	}();
	return A2(_elm_lang$core$String$append, 'http://danielnarey.com/elm-modular-ui', path);
};
...
var _danielnarey$elm_modular_ui$Page$fromPath = function (path) {
	var parsed = A2(
		...
		switch (_p2) {
			...
			case 'interactive-elements':
				return A2(
					...
					_danielnarey$elm_modular_ui$Page_Interactive$fromPath(
						A2(_elm_lang$core$List$drop, 1, parsed)));
			case 'content-elements':
				return A2(
					_elm_lang$core$Maybe$map,
					_danielnarey$elm_modular_ui$Page$Content,
					_danielnarey$elm_modular_ui$Page_Content$fromPath(
						A2(_elm_lang$core$List$drop, 1, parsed)));
			case 'customize':
				return A2(
					_elm_lang$core$Maybe$map,
					_danielnarey$elm_modular_ui$Page$Customize,
					_danielnarey$elm_modular_ui$Page_Customize$fromPath(
						A2(_elm_lang$core$List$drop, 1, parsed)));
			default:
				return _elm_lang$core$Maybe$Nothing;
		}
...
var _danielnarey$elm_modular_ui$Model$fromLocation = function (location) {
	...
	return A2(
		...
		_danielnarey$elm_modular_ui$Page$fromPath(location.pathname));
};
	...
	return _danielnarey$elm_modular_ui$Ui$render(
		A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _danielnarey$elm_modular_ui$View_Interactive$button,
					_1: {
						ctor: '::',
						_0: _danielnarey$elm_modular_ui$View_Interactive$input(model),
						_1: {ctor: '[]'}
					}
				})));
};
...
var _danielnarey$elm_modular_ui$Main$main = A2(
	...
	A2(
		_danielnarey$elm_semantic_dom$Dom_Program$update,
